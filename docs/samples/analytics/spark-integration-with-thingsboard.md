...
![image](../../../.gitbook/assets/spark-thingsboard-integration.svg)
...
In order to store and visualize the results of the analytics, we are going to create one virtual device for each geo-location zone. This is possible using special ThingsBoard MQTT Gateway [API](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/reference/gateway-mqtt-api/README.md). This API allows to efficiently stream data from multiple devices using single MQTT session. So, in our case, the Spark Job itself acts as a gateway that publishes data on behalf of several virtual devices. Let's name this gateway as an **Analytics Gateway**.

### Prerequisites

The following services must be up and running:

* ThingsBoard [instance](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/user-guide/install/installation-options/README.md)
...
The [sample application](https://github.com/thingsboard/samples/tree/master/spark-kafka-streaming-integration) used in ths tutorial has a dependency on **org.thingsboard.common.data** project. It is not in the public maven repository, so you need to [build ThingsBoard from source](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/user-guide/install/building-from-source/README.md) before proceeding with this tutorial.

### ThingsBoard configuration steps

### Step 1. Kafka Plugin Configuration

We need to configure Kafka Plugin that will be used to push telemetry data to Kafka. You can find the detailed description of Kafka Plugin [here](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/reference/plugins/kafka/README.md).
...
[**Download**](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/samples/analytics/resources/kafka_plugin_for_spark_streaming_sample.json) the json with plugin descriptor and use [**these instructions**](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/user-guide/ui/plugins/README.md#plugin-import) to import it to your instance.

![image](../../../.gitbook/assets/kafka-plugin-configuration.png)

Don't forget to **activate** your new plugin instance by clicking on the corresponding button in plugin details!

![image](../../../.gitbook/assets/kafka-plugin-activation.png)
...
[**Download**](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/samples/analytics/resources/windspeed_telemetry_rule.json) the json with rule descriptor and use these [**instructions**](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/user-guide/ui/rules/README.md#rule-import) to import it to your instance.

Don't forget to **activate** your new rule instance by clicking on the corresponding button in rule details!

![image](../../../.gitbook/assets/kafka-rule-activation.png)
...
The filter expression below validates that two attributes are set for a particular device: **deviceType** and **geoZone**. You may notice that we check that **deviceType** is equal to "WeatherStation". The **cs** variable is a map that contains all client-side attributes. See corresponding [**filter**](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/reference/filters/device-attributes-filter/README.md) documentation for more details.

![image](../../../.gitbook/assets/kafka-rule-attributes.png)
...
![image](../../../.gitbook/assets/kafka-rule-timeseries.png)

See corresponding [**filter**](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/reference/filters/device-telemetry-filter/README.md) documentation for more details.
...
![image](../../../.gitbook/assets/kafka-rule-action.png)
...
![image](../../../.gitbook/assets/create-devices.png)
...
![image](../../../.gitbook/assets/wind-turbine-device-details.png)
...
![image](../../../.gitbook/assets/create-asset.png)
...
Now let's run **SparkKafkaStreamingDemoMain** class from the IDE or submit it to a Spark cluster. Sample app will be fetching all the messages from Kafka topic and send average wind speed telemetry to the appropriate Asset in _ThingsBoard_.

## Dry Run

Once _Kafka Plugin_ is configured, _'Analytics Gateway device'_ is provisioned and _Spark Streaming Application_ is running please start sending **windSpeed** telemetry from different devices.
...
Now let us send the telemetry for the **Wind Turbine 1**. The following [**send-randomized-windspeed-1.py**](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/samples/analytics/resources/send-randomized-windspeed-1.py) script will send randomized windSpeed values in the range between 30 and 35 inclusively. Just replace the **$WIND\_TURBINE\_1\_ACCESS\_TOKEN** with the actual value or set the environment variable:
...
![image](../../../.gitbook/assets/zone-a-telemetry-2.png)
...
The [**send-randomized-windspeed-3.py**](https://github.com/caoyingde/thingsboard.github.io/tree/9437083b88083a9b2563248432cbbe460867fbaf/docs/samples/analytics/resources/send-randomized-windspeed-3.py) will post telemetry for **Wind Turbine 3** with windSpeed fluctuating between 30 and 60:
...
![image](../../../.gitbook/assets/zone-b-propagated.png)

Open the **Zone B** Asset card to check out the telemetry:

![image](../../../.gitbook/assets/zone-b-telemetry.png)
