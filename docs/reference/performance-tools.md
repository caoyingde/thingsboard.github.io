...
![image](../../.gitbook/assets/connect-publish-disconnect.png)
...
![image](../../.gitbook/assets/connect-publish-publish-publish-disconnect.png)
...
This plugin finds _Simulation_ files in your project, compiles and runs them. Results will be stored inside of the target folder in a pretty format that you are able to inspect after the run:

![image](../../.gitbook/assets/gatling-indicators.png)

![image](../../.gitbook/assets/gatling-statistics.png)

![image](../../.gitbook/assets/gatling-number-of-requests-per-second.png)

![image](../../.gitbook/assets/gatling-number-of-responses-per-second.png)
